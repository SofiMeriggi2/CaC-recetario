...
//Si estan todos los elementos cargados enviamos el submit si no error

// if(firstname && lastname && email && password && country){
//     formRegister.addEventListener('submit', validarFormulario)
// }else{
//     console.log('Error eventos no encontrados')
// }

// function validarFormulario(event){
//     event.preventDefault(); //previene el envio automatico de formulario

//     let validator = true;

//     if(firstname.value == ''){
//         firstname.classList.add("error")
//         error.firstname.textContent = "Error, debes cargar tu nombre"
//         validator= false
//     }
